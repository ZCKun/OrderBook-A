...
namespace x2h
{
    namespace book
    {
        ...
        private:
            ...
            int64_t last_bid_price_;
            int64_t last_ask_price_;
            ...
            //std::list<type::data::Trade> trade_cache_;
        ...
        public:
            ...
            int64_t last_msg_time() const noexcept { return last_msg_time_; }
             ...
             * @return
            */
            const type::data::Order& best_bid() const noexcept { return best_bid_; }
            /*!
             * @brief 最优卖单
             * @return
            */
            const type::data::Order& best_ask() const noexcept { return best_ask_; }

            /*!
             * @brief 获取买队列
             * @return
            */
            const OrderQueue& get_bid_queue() const noexcept { return bids_; }
            /*!
             * @brief 获取卖队列
             * @return
            */
            const OrderQueue& get_ask_queue() const noexcept { return asks_; }
